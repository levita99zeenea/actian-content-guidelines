...
Each section covers a specific UI component and follows a consistent structure:

- **When to use** — conditions and context for using this component
- **Style** — copy format, casing, punctuation, and length rules
